        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-600 dark:text-gray-300">
              Build, automate, and optimize your AI agent workflows with our
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-base text-gray-600 dark:text-gray-300 text-center">
                Intuitive visual editor to design complex workflows without
                coding.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-base text-gray-600 dark:text-gray-300 text-center">
                Monitor performance and optimize your workflows with real-time
                analytics.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-blue-600 dark:bg-blue-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-blue-100">
            Join thousands of companies using Agent Workflow to build powerful
            AI systems.
          </p>
          <div className="mt-8">
            <Button
      ...
      <footer className="bg-gray-100 dark:bg-gray-950 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 border-t border-gray-200 dark:border-gray-800 pt-8 text-center text-sm text-gray-600 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Agent Workflow. All rights
            reserved.
          </div>
        </div>
      </footer>
