      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-card p-4 rounded-lg shadow">
            <h2 className="text-lg font-medium text-muted-foreground">Total Workflows</h2>
            <p className="text-3xl font-bold">{workflowStats.total}</p>
          </div>
          <div className="bg-card p-4 rounded-lg shadow">
            <h2 className="text-lg font-medium text-muted-foreground">Completed</h2>
            <p className="text-3xl font-bold text-green-500">{workflowStats.completed}</p>
          </div>
          <div className="bg-card p-4 rounded-lg shadow">
            <h2 className="text-lg font-medium text-muted-foreground">Failed</h2>
            <p className="text-3xl font-bold text-red-500">{workflowStats.failed}</p>
          </div>
          <div className="bg-card p-4 rounded-lg shadow">
            <h2 className="text-lg font-medium text-muted-foreground">In Progress</h2>
            <p className="text-3xl font-bold text-blue-500">{workflowStats.inProgress}</p>
          </div>
        </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b">
                  ...
                  <td className="py-2"><button className="text-blue-500 hover:underline">View</button></td>
                </tr>
                <tr className="border-b">
                  <td className="py-2">Image Recognition</td>
                  <td className="py-2">Today, 1:15 PM</td>
                  <td className="py-2"><span className="text-blue-500">Running</span></td>
                  <td className="py-2"><button className="text-blue-500 hover:underline">View</button></td>
                </tr>
                <tr className="border-b">
                  <td className="py-2">Text Analysis</td>
                  <td className="py-2">Yesterday, 5:45 PM</td>
                  <td className="py-2"><span className="text-red-500">Failed</span></td>
                  <td className="py-2"><button className="text-blue-500 hover:underline">View</button></td>
                </tr>
              </tbody>
            </table>
